...
[else]	
	[ptext layer=2 text="%text" y=%y x=%x size=%size face=%face color=%color name=%name bold=%bold time=%time edge=%edge shadow=%shadow overwrite=%overwrite ]
[endif]

[endmacro]
	
[macro name="tb_ptext_hide"]
	[freeimage name=%name layer=2 time=%time ]
[endmacro]
